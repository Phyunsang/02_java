...
public class ForExample { // 가능제공용 클래스
	 ...
	 * 
	 *  for (초기식; 조건식; 증감식) {
	 *  		조건식이 true 라면 박복 수행할 코드
	 *  }
	 *  
	 *  - 초기식 : for문을 제어하는 용도의 변수 선언
	 *  
	 *  - 조건식 : for문의 반복 여부를 지정하는 식.
	 *  		보통 초기식에 사영된 변수를 이용하여 조건식을 작성함.
	 *  
	 *  
	 *  - 증감식 : 초기식에 사용된 변수를
	...
	public void ex7() {
		...
		for(int dan = 2; dan <= 9; dan++) { // 2~9 단까지 차례대로 증가
			...
			for(int num =1; num <= 9; num++ ) { // 각 단에 곱해질 수 1~9까지 차레대로 증가
