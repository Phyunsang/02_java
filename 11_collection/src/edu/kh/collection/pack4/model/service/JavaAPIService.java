...
public class JavaAPIService {
	...
	public void mathod2() {
		...
		System.out.println("byte의 용량 : " + Byte.MIN_VALUE);
		...
		System.out.println("[String -> 기본 자로형 변환]");
	...
	/**
	 * String의 불변성(immutable, 변하지 않은 성징 == 상수)
	 * - 문자열이 수정되면 새로우 String 객체가 생성됨
	 * 
	 */
	public void mathod3() {
	...
	public void method5() {
		...
		String temp2 = new String("adcd"); // new 연산자로 생성
		String temp3 = new String("adcd"); // new 연산자로 생성
