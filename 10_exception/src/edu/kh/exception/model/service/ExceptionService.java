...
public class ExceptionService {
	...
	public void ex2() {
		...
		try {
			System.out.println("입력 1 : "); // java.util.InputMismatchException
			int num1 = sc.nextInt();
			
			System.out.println("입력 2 : "); // java.util.InputMismatchException
			int num2 = sc.nextInt();
	...
	public void ex3() {
		...
		// try - catch - finally
		// finaliy : try 구문에서 예외가 발생 하든 말든 무조건 마지막에 수행
	...
	public void ex4() {
		...
		// throws : 호출한 메서드에게 예외를 던점
		//		   -> 호출한 메서드에서 예외를 처리하라고 위임하는 행위
