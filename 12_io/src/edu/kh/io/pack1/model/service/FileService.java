...
public class FileService {
	 ...
	 *  슬래시	(/, Linuxm Mac) -> C:/workspace/04_Java
	 *  
	 *  - Java 언어의 특징 : 플랫폼(OS)에 독립적이다
	 *  -> OS관계 없이 똑같은 코드 작성이 가능
	 *  
	 *  -> 이 특징을 유지하기 위해 /, \ 둘 다 호환이 가능
	 *  	(런타임 시 실행되는 OS에 맞기 자동으로 변경)
	 *  
	 *  
	 *  *******************************************
	 *  
	...
	public void method1( ) {
		...
		// C:/io_test/20240222 폴더를 지정할 것
		File directory = new File("/io_test/20240222");
		// -> 처음 : 존재하지 않는 폴더를 관리하는 File 객체를 생성한 것
