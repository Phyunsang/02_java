...
public class ByteService {
	...
	public void bufferedFileByteOutput() {
		...
		/* BufferedOutputStream / BufferedInfutStream
		 * 
		...
		try {
			...
			bos.flush(); // 스트림에 남아있는 데이터 밀어내기(쏟아내기)ㄴ
	...
	/**
	 *  BufferedFileByteInput 보조 스트림을 이용한 성능 향상
	 */
	 ...
	 * 
	 * 2) 있으면 파일 내용을 모두 읽어오기 : FileInputStream + BufferedIntutStream
	 * 
	 * 3) 읽어온 내용을 같은 위체에 "파일명-copy" 이름으로 출력
	...
	public void fileCopy() {
		...
		try {
			...
			if(!file.exists()) { // 해당 경로에 파일이 존재하지 안으면
