...
import edu.kh.poly.ex2.model.service.PHSCalculator;
import edu.kh.poly.ex2.model.service.Calculator;

public class AbstractServiceRun {
	...
	public static void main(String[] args) {
		...
		//Calculator cal = new PHSCalculator();
		Calculator cal = new HGDCalculator();
		
		System.out.println("합 : " + cal.puls(20, 30));
