...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		System.out.println("arr의 주소값? : " + arr); // [I@1b26f7b2
		
		// 배열 요소 값 대입
		// arr은 int[] 참조형 변수 이지만
		// arr[0], arr[1], arr[2] 은 int 자료형 변수이기 때문에 정수 값을 대입할 수 있다!
		arr[0] = 10;
		arr[1] = 50;
		arr[2] = 1000;
	...
	public void ex7() {
		...
		int[] arr = {100, 200, 300, 400, 500, 600, 700, 800, 800, 1000};
	...
	public void ex9() {
		...
		// 3. 단, 알치하는 문자 없을 경우 "존재하지 않습니다" 출력
		/*
		 * ex)
		 * 문자열 입력 " hello
		 	[h, e, l, l, o]
