...
public class PrintExample {
	...
	public static void main(String[] args) {
		...
		// System.out.print() : 단수 출력(출력 후 줄바꿈 X)
		// System.out.println() : 한 줄 출력(출력 후 줄바꿈 수행)
		// 줄바꿈이라는 차이점은 이지만 괄호 안의 내용이 그대로 출력 된다는 것은 똑같음
		
		// System.out.println(); 자동완성 syso crtl+space
		...
		// System.out.print() : 출력될 문자열 형식을 패턴으로 지정하는 출력구문
		...
		//  \
		System.out.println("\\"); // 백슬(역슬래시) 출력방법
		
		//  \o/
		System.out.println("\\o/");
		
		System.out.println("a\tb\fc\td");
		// 한 공간씩 표현 X, 한 번에 공간차지
		
		// 유니코드 이스케이프
		System.out.println("\u0041"); // A
		// 유니코드(16진수)
		// 65 16진수로 표현
		// 65 나누기 16하면 몪이 4, 나머지가 1
